...
public class PlayState : FSMState
{
    ...
    {
        ctrl.view.ShowGameUI(ctrl.model.Score, ctrl.model.HighestScore);
        ctrl.view.ShowCtrlShapeUI();
        ctrl.gameManager.StartGame();
    }
    public override void DoBeforeLeaving()
    {
        ctrl.view.HideGameUI();
        ctrl.view.HideCtrlShapeUI();
    ...
    public void OnRestartButtonClick()
    {
        ...
        ctrl.model.Restart();
        ctrl.gameManager.StartGame();
        ctrl.view.UpdateGameUI(0, ctrl.model.HighestScore);
    }
}
